...
], authenticateUser, StudentController.createStudent);

router.get('/allstudents', authenticateUser, StudentController.getAllStudents);
router.get('/search', authenticateUser, StudentController.searchStudents);
...
], authenticateUser, StudentController.updateStudent);

router.delete('/:admission_no', authenticateUser, StudentController.deleteStudent);

router.get('/birthcertificate', authenticateUser, StudentController.birthCertificate);
